...
public static void main(String[]args)
{
	...
	if(P==1006)
	{
        System.out.println("Login Sucessfully at: " + cal.get(Calendar.HOUR)+":"+cal.get(Calendar.MINUTE)+":"+cal.get(Calendar.MILLISECOND));
	}
		else {
...
break;
case 5:
	System.out.println("Logout Sucessfully at: " + cal.get(Calendar.HOUR)+":"+cal.get(Calendar.MINUTE)+":"+cal.get(Calendar.MILLISECOND));
	System.exit(0);
